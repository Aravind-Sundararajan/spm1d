...
from spm1d.rft1d.prob import RFTCalculator, RFTCalculatorResels
...
class Gaussian(_RFTDistribution):
    ...
    def p_cluster(self, k, u, nodes, FWHM, withBonf=False):
        return super(Gaussian, self).p_cluster(
            k, u, None, nodes, FWHM, withBonf
        )

    def p_set(self, c, k, u, nodes, FWHM, withBonf=False):
        return super(Gaussian, self).p_set(
            c, k, u, None, nodes, FWHM, withBonf
        )
...
class StudentsT(_RFTDistribution):
    ...
    def p_cluster(self, k, u, df, nodes, FWHM, withBonf=False):
        return super(StudentsT, self).p_cluster(
            k, u, df, nodes, FWHM, withBonf
        )
...
class FisherSnedecorF(_RFTDistribution):
    ...
    def isf(self, alpha, df, nodes, FWHM, withBonf=False):
        return super(FisherSnedecorF, self).isf(
            alpha, df, nodes, FWHM, withBonf
        )
    ...
    def p_cluster(self, k, u, df, nodes, FWHM, withBonf=False):
        return super(FisherSnedecorF, self).p_cluster(
            k, u, df, nodes, FWHM, withBonf
        )

    def p_set(self, c, k, u, df, nodes, FWHM, withBonf=False):
        return super(FisherSnedecorF, self).p_set(
            c, k, u, df, nodes, FWHM, withBonf
        )
...
class HotellingsT2(_RFTDistribution):
    ...
    def p_cluster(self, k, u, df, nodes, FWHM, withBonf=False):
        return super(HotellingsT2, self).p_cluster(
            k, u, df, nodes, FWHM, withBonf
        )

    def p_set(self, c, k, u, df, nodes, FWHM, withBonf=False):
        return super(HotellingsT2, self).p_set(
            c, k, u, df, nodes, FWHM, withBonf
        )

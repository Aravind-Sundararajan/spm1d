...
class KendallRandomNumbers(_base.DatasetNormality):
    def _set_values(self):
        ...
        self.note = (
            "Note     ",
            "Original data are from p.194 of:  Kendall M (1948) Rank Correlation Methods, Charles Griffin & Company Ltd.",
        )
...
class RFaithful(_base.DatasetNormalitySW):
    def _set_values(self):
        ...
        self.note = (
            "Note     ",
            'Subset of the Old Faithful dataset "faithful" in R (r-project.org);  the Shapiro-Wilk test was conducted only on responses with values greater than three.',
        )
...
class RSShapiroWilk1(_base.DatasetNormalitySW):
    def _set_values(self):
        ...
        self.note = (
            "Note     ",
            "Shapiro-Wilk Expanded Test, Example 3, Sample 1",
        )
...
class RSShapiroWilk2(_base.DatasetNormalitySW):
    def _set_values(self):
        ...
        self.note = (
            "Note     ",
            "Shapiro-Wilk Expanded Test, Example 3, Sample 2",
        )
...
class RSShapiroWilk3(_base.DatasetNormalitySW):
    def _set_values(self):
        self.www = "http://www.real-statistics.com/tests-normality-and-symmetry/statistical-tests-normality-symmetry/shapiro-wilk-expanded-test/"
        self.Y = np.array(
            [145, 125, 190, 135, 220, 5, 130, 210, 3, 165, 165, 150, 60]
        )
        self.z = 0.89263
        self.p = 0.105972
        self.note = (
            "Note     ",
            "Shapiro-Wilk Expanded Test, Example 3, Sample 3",
        )
...
class ZarBiostatisticalAnalysis68(_base.DatasetNormality):
    def _set_values(self):
        self.www = (
            "https://mathworks.com/matlabcentral/fileexchange/3954-dagosptest"
        )
        self.Y = np.array(
            [
                63,
        ...
        self.note = (
            "Note     ",
            'Data available in "DagosPtest.m" at Matlab Central.  Data are from Example 6.8 (p.89) in:  Zar JH (1999), Biostatistical Analysis (2nd ed.). NJ: Prentice-Hall, Englewood Cliffs. ',
        )
